...
export default class Home extends React.Component {
  render() {
    return (
      <Container>
        <div style={{textAlign: 'center', padding: '20px'}}><h6 className="text-primary">~ NEW ~</h6></div>

        {/*Images*/}
        <Row>
          <Col md={6} xs={12} className="text-center">
            <img className="homeImage" src={images[0]} alt="test"></img>
            <div class="itemPrice">P 50.00</div>
            <div class="itemDescription">Coconut and Shaffron Mussels</div>
          </Col>

          <Col md={6} xs={12} className="text-center">
            <img className="homeImage" src={images[1]} alt="test2s"></img>
            <div class="itemPrice">P 120.00</div>
            <div class="itemDescription">Moroccan Lamb with Apricots</div>
          </Col>
        </Row>
      </Container>
    );
