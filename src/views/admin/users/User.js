          ...
          <div className="card-header">Name : {this.state.user.name}</div>
              <div className="card-body"> 
                <div className="row">
                  ...
                  <p className="card-text">First Name : {this.state.user.fname}</p>
                  <p className="card-text">Password : {this.state.user.password}</p>  
                  <p className="card-text">Last Name : {this.state.user.lname}</p>  
                    <p className="card-text">Email : {this.state.user.email}</p>                 
                    <p className="card-text">Phone : {this.state.user.phone}</p>
                    <p className="card-text">Address : {this.state.user.address}</p> 
                    <p className="card-text">Birthday : {this.state.user.birthday}</p> 
